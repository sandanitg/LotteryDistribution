...
function fillCombo2(combo,message,list,attribute,selectedvalue,attribute2=null,valueFactory=null) {
    ...
    for (index in  list) {
        ...
        if(valueFactory==null) {
            if(attribute2==null)
                displayvalue = list[index][attribute];
            else
                displayvalue = list[index][attribute][attribute2];
        }
        else
        {  displayvalue=valueFactory(list[index]); }
